...
mabel = Challenge.create!(name: 'Help Mabel fix her roof', description: 'Mabel Ruthridge is a 72 year old lifelong resident of Pleasantville, and she has a leak in her roof. She cannot afford repairs on her Social Security income.  Lets help her!')
...
runner = Challenge.create!(name: 'Run a half marathon with Mom!', description: 'I want my daughter to train and run a half marathon with me!')

puppy = Challenge.create!(name: 'Find homes for 50 rescue animals.', description: 'We want to find a good home for 50 pets from the animal shelter. Visit the shelter if possible, take pictures and post on social media.')
